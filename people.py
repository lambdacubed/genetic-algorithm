...
class person(object):
	"""A person is the object written to the opt_device actuators. 
	...
	def test_person(self, opt_device, daq_device, opt_comm_device):
		"""write each person to the opt_device to measure the figure of merits

		Parameters
		----------
		opt_device : object from opt_device_functions.py
